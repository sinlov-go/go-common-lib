# This dockerfile uses extends image https://hub.docker.com/sinlov-go/go-common-lib
# VERSION 1
# Author: sinlov
...
ARG GO_ENV_PACKAGE_NAME=github.com/sinlov-go/go-common-lib
ARG GO_ENV_ROOT_BUILD_BIN_NAME=go-common-lib
ARG GO_ENV_ROOT_BUILD_BIN_PATH=build/${GO_ENV_ROOT_BUILD_BIN_NAME}
ARG GO_ENV_ROOT_BUILD_ENTRANCE=cmd/go-common-lib/main.go
...
ENTRYPOINT [ "/app/go-common-lib" ]
# CMD ["/app/go-common-lib", "--help"]